...
struct RaytracingCamera {
	...
	virtual Ray getRay(double x, double y, const int& row, const int& col, const int& N) const = 0;
...
protected:
	...
	dvec2 getProjectionPlaneCoordinates(double x, double y, const int& row, const int& col, const int& N) const;
public:
...
struct PerspectiveCamera : public RaytracingCamera {
	...
	virtual Ray getRay(double x, double y, const int& row, const int& col, const int& N) const;
